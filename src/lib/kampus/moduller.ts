  ...
  },
  {
    ...
    moduller: [
      ...
      },
      {
        slug: "odeme-defteri",
        ad: "Ödeme defteri",
        ozet: "Ay ay alınan paket ödemeleri ve ciro. Excel'deki aylık sayfaların yerine.",
        yol: "/kampus/odeme-defteri",
        ikon: "Sayilar",
        roller: ["admin"],
        durum: "hazir",
      },
      {
        slug: "giderler",
        ad: "Giderler",
        ozet: "Elden verilen ödemeler, kasa çıkışları ve su kartı.",
        yol: "/kampus/giderler",
        ikon: "Rozet",
        roller: ["admin"],
        durum: "hazir",
  ...
  },
  {
    ...
    moduller: [
      ...
      },
      {
        slug: "dogum-gunleri",
        ad: "Doğum günleri",
        ozet: "Doğum günü organizasyonları: tarih, kapora, kişi sayısı, menü ve süsleme.",
        yol: "/kampus/dogum-gunleri",
        ikon: "Balon",
        roller: ["admin"],
        durum: "hazir",
      },
      {
        slug: "devamsizlik",
        ad: "Devamsızlık çizelgesi",
        ozet: "Excel'den gelen çocuk × ay devamsızlık tablosu.",
        yol: "/kampus/devamsizlik",
        ikon: "Tik",
        roller: ["admin", "ogretmen"],
        durum: "hazir",
      },
      ...
      },
      {
        slug: "excel-arsivi",
        ad: "Excel arşivi",
        ozet: "Kayıtlı çocuk listesi Excel'inin sayfa sayfa, hücre hücre ham kopyası.",
        yol: "/kampus/excel-arsivi",
        ikon: "Not",
        roller: ["admin"],
        durum: "hazir",
      },
